                                ...
                                <div class="col-md-12">
                                    ...
                                    <form method="GET" action="cetak1.php"  >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="page" type="hidden"  value="pembelian" />
                                        ...
                                        <div>
                                        	...
                                        	<input type="submit" name="cetak" value="Cetak" target="blank"  class="btn btn-primary">
                                             <a href="cetak.php?page=pembelian" class="btn btn-default" style="margin-top: 8px; margin-left: 5px;"> Cetak Semua</a>
                                        </div>
                                 </div>
