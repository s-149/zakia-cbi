        ...
        <div class="col-md-12">
            <form method="POST" enctype="multipart/form-data" onsubmit="return validasi(this)" >
                <div class="form-group">
                    ...
                    <input class="form-control" name="Kd_supplier" id="Kd_supplier" />
                    
                </div>

                <div class="form-group">
                    <label>Nama_supplier</label>
                    <input class="form-control" name="Nama_supplier" type="Nama_supplier" id="Nama_supplier" />
 ...
 <?php
    ...
    //$Website = $_POST['Website'];
 	...
 	if ($simpan) {        
 		...
 		$sql = $koneksi->query("insert into `tsupplier`(`Kd_supplier`, `Nama_supplier`, `Alamat`, `Email`, `Tlp`)values('$Kd_supplier', '$Nama_supplier', '$Alamat', '$Email', '$Tlp')");
