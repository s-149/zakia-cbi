                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <form method="POST" enctype="multipart/form-data" onsubmit="return validasi(this)" >
                                        ...
                                        <div class="form-group">
                                            <label>Foto</label>
                                            <label><img src='images/pengguna/<?php echo $data['foto'];?>' width="100" height="75"></label>
 ...
 <?php
    ...
    $Gambar=date('d_M_Y_h_i_s').'_'.$foto;
 	...
 	if ($simpan) {
        ...
        $upload = move_uploaded_file($lokasi, "images/pengguna/".$Gambar);
 		
 		$sql = $koneksi->query("update  tb_user set username='$username', password='$pass', nama='$nama', foto='$Gambar' where id='$id'");
