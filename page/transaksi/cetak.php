                                ...
                                <div class="col-md-12">
                                    ...
                                    <form method="GET" action="cetak1.php"  >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="page" type="hidden" value="transaksi"  />
                                        ...
                                        <div>
                                        	...
                                        	<input type="submit" name="cetak" value="Cetak" target="blank"  class="btn btn-primary">
                                             <a href="cetak.php?page=transaksi" class="btn btn-default" target="blank" style="margin-top: 8px; margin-left: 5px;"> Cetak Semua</a>
                                        </div>
                                 </div>
